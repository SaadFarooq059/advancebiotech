  ...
  return (
    <>
      ...
      <div className="block md:hidden">
        {/* Simple floating circles for mobile */}
        <motion.div
          className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-br from-purple-200 to-purple-300 rounded-full opacity-40"
        ...
        <motion.div
          className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-green-200 to-green-300 rounded-full opacity-30"
          initial={{ scale: 0, rotate: 0 }}
          animate={{ scale: 1, rotate: -360 }}
          transition={{ 
            duration: 2.5, 
        ...
        <motion.div
          className="absolute top-1/2 -right-2 w-8 h-0.5 bg-gradient-to-r from-purple-400 to-green-400 rounded-full opacity-50"
          initial={{ width: 0 }}
          animate={{ width: 32 }}
      ...
      {/* Desktop Version - Full Decorative Elements */}
