...
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }: GalleryModalProps) => {
    ...
    return (
        <>
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-purple-400/20 backdrop-blur-xl 
                    ...
                    <div className="flex items-center -space-x-2 px-3 py-2">
                        {mediaItems.map((item, index) => (
                            <motion.div
                                ...
                                className={`
                                    ...
                                    ${selectedItem.id === item.id
                                        ...
                                        : 'hover:ring-2 hover:ring-green-400/30'}
                                `}
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-purple-500/5 to-green-500/20" />
                                {selectedItem.id === item.id && (
                                    <motion.div
                                        layoutId="activeGlow"
                                        className="absolute -inset-2 bg-purple-500/20 blur-xl"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
            ...
            <div className="mb-8 text-center">
                <motion.h1
                    className="text-2xl sm:text-3xl md:text-4xl font-bold bg-clip-text text-transparent 
                             ...
                             dark:from-white dark:via-green-400 dark:to-white"
