...
export default function Vision() {
  ...
  const achievements = [
    { number: "2018", label: "Established", icon: <Star className="h-6 w-6 text-purple-600" /> },
    { number: "500+", label: "Healthcare Partners", icon: <Users className="h-6 w-6 text-green-600" /> },
    { number: "1000+", label: "Products Supplied", icon: <Award className="h-6 w-6 text-purple-600" /> },
    { number: "24/7", label: "Support Available", icon: <Heart className="h-6 w-6 text-green-600" /> }
  ];
  ...
  const futureGoals = [
    ...
    },
    {
      ...
      color: "bg-gradient-to-br from-green-50 to-purple-50"
    },
    {
      year: "2027",
      ...
      color: "bg-gradient-to-br from-purple-50 to-green-50"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-purple-600 via-purple-700 to-green-600 text-white py-24 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-purple-300/10 rounded-full blur-2xl"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <Badge className="bg-purple-800/50 text-purple-100 hover:bg-purple-900/50 mb-6 px-8 py-3 text-lg">
          ...
          <p className="text-xl text-purple-100 max-w-4xl mx-auto leading-relaxed mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {visionPoints.map((point, index) => (
              <Card key={index} className={`group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br ${point.gradient} overflow-hidden relative`}>
                <div className="absolute -top-10 -right-10 w-32 h-32 bg-purple-200/30 rounded-full blur-xl group-hover:bg-purple-300/40 transition-all duration-500"></div>
            ...
            {achievements.map((achievement, index) => (
              <Card key={index} className="group text-center p-8 hover:shadow-xl transition-all duration-300 border-0 bg-white">
                <CardContent className="p-0">
                  <div className="mb-6 p-4 bg-purple-50 rounded-2xl w-fit mx-auto group-hover:bg-purple-100 transition-colors">
                    {achievement.icon}
                  </div>
                  <div className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-green-600 bg-clip-text text-transparent mb-3 group-hover:scale-110 transition-transform duration-300">
                    {achievement.number}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-8">
                ...
                <span className="text-purple-600"> Healthcare Future</span>
              </h2>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Card className="p-12 bg-gradient-to-br from-purple-50 via-white to-green-50 shadow-2xl border-0 relative overflow-hidden">
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-purple-200/20 rounded-full blur-2xl"></div>
            <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-green-300/20 rounded-full blur-2xl"></div>
            <CardContent className="text-center relative z-10">
              <div className="p-6 bg-gradient-to-br from-purple-100 to-green-100 rounded-2xl w-fit mx-auto mb-8">
              ...
              <div className="flex justify-center items-center space-x-8 text-purple-600">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600">Patient</div>
            ...
            {futureGoals.map((goal, index) => (
              <Card key={index} className={`group hover:shadow-xl transition-all duration-300 border-0 ${goal.color} overflow-hidden relative`}>
                ...
                <CardHeader className="text-center pb-4 relative z-10">
                  <Badge className="bg-gradient-to-r from-purple-600 to-green-600 text-white hover:from-purple-700 hover:to-green-700 mb-4 w-fit mx-auto px-4 py-2 text-lg">
                    {goal.year}
                  </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <Card className="p-8 bg-white/95 backdrop-blur-sm border-0 hover:bg-white transition-colors">
              <CardContent className="text-center p-0">
                ...
                <p className="text-purple-600 font-bold text-lg">0335 5359327</p>
              </CardContent>
            </Card>
            ...
            <Card className="p-8 bg-white/95 backdrop-blur-sm border-0 hover:bg-white transition-colors">
              <CardContent className="text-center p-0">
                ...
                <p className="text-green-600 font-bold">info@advancebiotech.net</p>
              </CardContent>
            </Card>
          </div>
